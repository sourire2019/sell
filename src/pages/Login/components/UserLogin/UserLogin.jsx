...
export default class UserLogin extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      value: {
        account: cookie.load("user")== undefined ? (undefined) : (cookie.load("user").account),
        password: cookie.load("user")== undefined ? (undefined) : (cookie.load("user").password),
        checkbox: cookie.load("user")== undefined ? (false) : (cookie.load("user").checkbox),
      },
    };
  }
  ...
  handleSubmit = async(e) => {
    ...
    if(result.message == "success"){
      ...
      if(this.state.value.checkbox == true) {
        cookie.save("user" , this.state.value)
      }else{
        cookie.remove("user")
      }
